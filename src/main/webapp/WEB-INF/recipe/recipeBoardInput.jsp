...
<div style="max-width:1000px; margin:0 auto;"> 
	<form action="./insertMarketBoard" method="post" enctype="multipart/form-data">
		...
		<input type="text" name="recipeContent" class="form-control borderGreen" required autofocus value="${recipeContent}" style="height: 70px;"
		...
		<td>
			<div id="order-container">
				<div class="order-row">
					<input type="text" name="recipeOrderContent" class="form-control borderGreen" required autofocus value="${recipeOrderContent}" style="height: 100px;"
			placeholder="예 : 파를 다듬어 줍니다.">
		...
		<div class="text-center">
			...
			<button type="button" class="btn btn_product_input mt-3 ml-2" onclick="addOrder()">추가</button>
		</div>
